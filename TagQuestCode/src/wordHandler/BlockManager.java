...
public class BlockManager 
{
	...
	protected WordTagDisplay newWord;
...
//		}
	...
	public void generateWordBlock(ArrayList<String> wordList, int[] tagWeights)
	{
		...
		for(int x = 0; x < wordBlock.size(); x++)
		{
			...
			//System.out.println("StartPlacement1");
			newWord = new WordTagDisplay(newTag);
			//System.out.println("StartPlacement2");
			newWord.init();
			//System.out.println("StartPlacement3");
			gameHandler.addNewWordCube(newWord);
			//System.out.println("StartPlacement4");
